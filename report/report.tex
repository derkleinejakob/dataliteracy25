...
The establishment of right-wing populist parties in 21st century Europe has significantly changed parliamentary discourse \citep{schwalbach2023talking}. A recent analysis of EP speech embeddings has identified a gradual increase in emotional rhetoric since 1999, with right-wing populist groups leading the trend \citep{subtil_verger_2024}. 

Right-wing populist parties have also been a driving force in the increasing politicization of immigration \citep{hutter_politicising_2022}, which has become a salient topic in European election campaigns \citep{dekeyser_elections_2023} and media coverage \citep{greussing_shifting_2017}. Since the beginning of the so-called `refugee crisis' in Europe in 2015 \citep{brueckner_crisis_2026}, messaging around immigration can be characterized by increasing anti-solidarity in the German parliament, not only for right-wing, but also christian-conservative and liberal parties \citep{kostikova_llm_2025}.
